...
def ativar_codigo():
    ...
    if isinstance(resultados, list):
        ...
        diretorio_relatorios = diretorio_atual / 'CaminhosDosArquivos/BancoDeCaminhos'
        diretorio_relatorios.mkdir(parents=True, exist_ok=True)
        
        arquivo_excel = diretorio_relatorios / f'pastas_arquivos.xlsx'
            ...
            for item in pasta.iterdir():
                if item.is_dir():
                    ...
                    if item.suffix.lower() == '.pdf':  # Verifica se o arquivo é PDF
                        ...
                        pastas_arquivos.append({'Caminho': str(item)})
                    else:
                        pastas_arquivos.append({'Caminho': str(item)})
